...
public class AddViewCatherineGameHistory extends HttpServlet {

	public void doGet(HttpServletRequest request, HttpServletResponse response)
			throws IOException, ServletException {
		VainGloryBusiness vgb = new VainGloryBusinessImpl();

		List<GameHistoryStats> gameHistoryStats = vgb.getCatherineGameHistoryStats();
		...
		RequestDispatcher view = request.getRequestDispatcher("AddViewCatherineGameHistory.jsp");
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(ally1!=null && !ally1.equals("") 
		   ...
		   && enemy3!=null && !enemy3.equals("")){
			vgb.addCatherineGameHistory(isVictory, 
