...
public class AddViewGameHistory extends HttpServlet {

	public void doGet(HttpServletRequest request, HttpServletResponse response)
			throws IOException, ServletException {
		VainGloryBusiness vgb = new VainGloryBusinessImpl();
		
		List<GameHistoryStats> gameHistoryStats = vgb.getGameHistoryStats();
		...
		RequestDispatcher view = request.getRequestDispatcher("AddViewGameHistory.jsp");
