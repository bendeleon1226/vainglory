...
public class AddViewAdagioGameHistory extends HttpServlet {

	public void doGet(HttpServletRequest request, HttpServletResponse response)
			throws IOException, ServletException {
		VainGloryBusiness vgb = new VainGloryBusinessImpl();

		List<GameHistoryStats> gameHistoryStats = vgb.getAdagioGameHistoryStats();
		...
		RequestDispatcher view = request.getRequestDispatcher("AddViewAdagioGameHistory.jsp");
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(ally1!=null && !ally1.equals("") 
		   ...
		   && enemy3!=null && !enemy3.equals("")){
			vgb.addAdagioGameHistory(isVictory, 
